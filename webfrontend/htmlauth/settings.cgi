...
<body id="ekz-plugin" class="plugincontent">
  ...
  <div class="nav-actions">
    ...
    <a class="btn btn-primary"   href="@{[ h($BASEURL) ]}/run_rolling_fetch.cgi"><span class="emoji">⚡</span> Fetch now</a>
    <a class="btn btn-primary"  href="@{[ h($BASEURL) ]}/health.cgi"><span class="emoji">🩺</span> Health</a>
